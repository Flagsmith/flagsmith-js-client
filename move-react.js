...
try {
    fs.rmdirSync(path.join(__dirname,"lib/flagsmith/utils"), {recursive:true})
} catch (e){}
try {
    fs.rmdirSync(path.join(__dirname,"lib/flagsmith/es/utils"), {recursive:true})
} catch (e){}
try {
    fs.rmdirSync(path.join(__dirname,"lib/react-native-flagsmith/utils"), {recursive:true})
} catch (e){}
