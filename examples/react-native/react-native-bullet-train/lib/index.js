...
var defaultAPI = 'https://api.bullet-train.io/api/v1/';
var BulletTrain = (_temp =
/*#__PURE__*/
function () {
  function BulletTrain(props) {
    ...
    _defineProperty(this, "getJSON", function (url, method, body) {
    ...
    _defineProperty(this, "getFlags", function (resolve, reject) {
      ...
      if (identity) {
        return Promise.all([_this.getJSON(api + 'identities/?identifier=' + encodeURIComponent(identity))]).then(function (res) {
    ...
    _defineProperty(this, "getTrait", function (key) {
      var trait = _this.traits && _this.traits[key];
      return trait;
    });

    _defineProperty(this, "setTrait", function (key, trait_value) {
      ...
      return getJSON("".concat(api, "traits/"), 'POST', JSON.stringify(body)).then(_this.getFlags);
    });

    _defineProperty(this, "incrementTrait", function (trait_key, increment_by) {
      var getJSON = _this.getJSON,
          identity = _this.identity,
          api = _this.api;
      return getJSON("".concat(api, "traits/increment-value/"), 'POST', JSON.stringify({
        trait_key: trait_key,
    ...
    _defineProperty(this, "hasFeature", function (key) {
      var flag = _this.flags && _this.flags[key];
      var res = false;
  ...
  _createClass(BulletTrain, [{
    ...
    value: function init(_ref4) {
      ...
      var environmentID = _ref4.environmentID,
          _ref4$api = _ref4.api,
          api = _ref4$api === void 0 ? defaultAPI : _ref4$api,
      ...
      return new Promise(function (resolve, reject) {
        _this2.environmentID = environmentID;
        _this2.api = api;
        _this2.interval = null;
        _this2.disableCache = disableCache;
        _this2.onChange = onChange;
        _this2.onError = onError;
        _this2.flags = Object.assign({}, defaultFlags) || {};
        ...
        if (!disableCache) {
          AsyncStorage.getItem(BULLET_TRAIN_KEY, function (err, res) {
            ...
            if (_this2.flags && _this2.onChange) {
              _this2.onChange(null, {
                isFromServer: false
              });
            }

            _this2.getFlags(resolve, reject);
          });
        }
      });
    }
    ...
    key: "getSegments",
    value: function getSegments() {// noop for now
...
/* harmony import */ var _callstack_async_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @callstack/async-storage */ "./node_modules/@callstack/async-storage/lib/index.js");
/* harmony import */ var _callstack_async_storage__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_callstack_async_storage__WEBPACK_IMPORTED_MODULE_0__);


var bt = __webpack_require__(/*! ./bullet-train-core */ "./bullet-train-core.js");

/* harmony default export */ __webpack_exports__["default"] = (bt({
  AsyncStorage: _callstack_async_storage__WEBPACK_IMPORTED_MODULE_0___default.a
}));

/***/ }),

/***/ "./node_modules/@callstack/async-storage/lib/index.js":
/*!************************************************************!*\
  !*** ./node_modules/@callstack/async-storage/lib/index.js ***!
  \************************************************************/
/*! no static exports found */
