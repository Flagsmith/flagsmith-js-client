...
The SDK clients for web and React Native for [https://flagsmith.com/](https://flagsmith.com/). Flagsmith allows you to
manage feature flags and remote config across multiple projects, environments and organisations.

## Getting Started

For full documentation visit
[https://docs.flagsmith.com/clients/javascript/](https://docs.flagsmith.com/clients/javascript/)
...
`identify`, `setTrait` and `setTraits` all trigger calls to `getFlags`, which in turn hits the get flags endpoint. This
is due to identities and traits affecting flags that are returned.
