(function (global, factory) {
	...
	***************************************************************************** */
	...
	var global$1 = typeof global$1 != "undefined" ? global$1 : typeof window != 'undefined' ? window : {};
	var _fetch;
	var AsyncStorage;
	...
	var Flagsmith = /** @class */ (function () {
	    function class_1(props) {
	        ...
	        if (props.fetch) {
	            ...
	            _fetch = typeof fetch !== 'undefined' ? fetch : global$1.fetch;
	        }
	...
	var flagsmith = core({ AsyncStorage: _default, fetch: fetch$1 });
	if (typeof window !== "undefined") {
	    // @ts-ignore
	    window.flagsmith = flagsmith;
	}
	var createFlagsmithInstance = function () {
	    return core({ AsyncStorage: _default, fetch: fetch$1 });
	};
