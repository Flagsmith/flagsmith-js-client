(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.flagsmith = {}));
	...
	***************************************************************************** */
	...
	var defaultAPI = 'https://api.flagsmith.com/api/v1/';
	...
	var Flagsmith = /** @class */ (function () {
	    function class_1(props) {
	        ...
	        this.getFlags = function (resolve, reject) {
	            ...
	            var resolved = false;
	            var handleResponse = function (_a, segments) {
	                ...
	                if (segments) {
	                    ...
	                    segments.map(function (s) {
	                        userSegments_1[s.name] = s;
	                    });
	                    _this.segments = userSegments_1;
	                }
	        ...
	        this.setTraits = function (traits) {
	            ...
	            var body = Object.keys(traits).map(function (key) { return ({
	                "identity": {
	                    "identifier": identity
	                },
	                "trait_key": key,
	            ...
	            return getJSON("".concat(api, "traits/bulk/"), 'PUT', JSON.stringify(body))
	                .then(function () {
	                if (_this.initialised) {
	                    _this.getFlags();
	                }
	        ...
	        this.incrementTrait = function (trait_key, increment_by) {
	            var _a = _this, getJSON = _a.getJSON, identity = _a.identity, api = _a.api;
	    ...
	    class_1.prototype.init = function (_a) {
	        var _this = this;
	        var environmentID = _a.environmentID, _b = _a.api, api = _b === void 0 ? defaultAPI : _b, headers = _a.headers, onChange = _a.onChange, cacheFlags = _a.cacheFlags, onError = _a.onError, defaultFlags = _a.defaultFlags, preventFetch = _a.preventFetch, enableLogs = _a.enableLogs, enableAnalytics = _a.enableAnalytics, _AsyncStorage = _a.AsyncStorage, state = _a.state;
	        return new Promise(function (resolve, reject) {
	...
	var flagsmith = core({ AsyncStorage: _default, fetch: fetch });
	if (typeof window !== "undefined") {
	    // @ts-ignore
	    window.flagsmith = flagsmith;
	}
	var createFlagsmithInstance = function () {
	    return core({ AsyncStorage: _default, fetch: fetch });
	};
